...
public abstract class AbstractCollection<E> implements Collection<E>
{
	...
	/*public <T> T[] toArray(T[] var1) {
		int var2 = this.size();
		Object[] var3 = var1.length >= var2
				? var1
				: (Object[]) ((Object[]) Array.newInstance(var1.getClass().getComponentType(), var2));
	...
	private static <T> T[] finishToArray(T[] var0, Iterator<?> var1) {
		int var2;
		for (var2 = var0.length; var1.hasNext(); var0[var2++] = (T) var1.next()) {
